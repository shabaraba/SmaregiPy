...
class HeadEntity(BaseEntity):
    ...
    def __init__(self, head: Optional[dict] = None):
...
class Transaction(BaseServiceRecordApi):
    ...
    children: Dict[str, BaseServiceApi] = {
        'details': TransactionDetailCollection()
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        if isinstance(details, list):
            self.children['details'] = TransactionDetailCollection(
                data=details,
                path_params=self.path_params,
            )
        else:
    ...
    @property
    def details(self):
        return self.children.get('details')
...
class TransactionCollection(BaseServiceCollectionApi):
    ...
    def __init__(
        ...
        **kwargs
        ...
        BaseServiceCollectionApi.__init__(self, data, path_params)
        self.records = { 
            each_data['transactionHeadId']: Transaction(
                data=each_data,
                fetched_data=True,
                path_params=self.path_params,
            )
